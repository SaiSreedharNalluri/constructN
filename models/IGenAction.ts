...
export interface IGenNotifyViewerAction {
    type: "loadGenViewer" | "syncGenViewer" | "setViewMode" | "setViewType" | "setViewerContext" | "addViewLayer" | "removeViewLayer" | "setCompareMode" | 'closeGenViewer' | 'setStructure'|
    ...
    data? :string |[string] | [ITasks] | [Issue] | [IHotspot] | IViewerContext | IGenData
