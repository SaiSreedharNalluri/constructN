...
import CreateIssue from "../components/divami_components/create-issue/CreateIssue";
...
jest.mock("../services/issue.ts", () => ({
  getIssuesTypes: jest.fn(() => Promise.resolve({ success: true, result: ["siva", "batman"] })),
  getIssuesPriority: jest.fn(() => Promise.resolve({ success: true, result: ["siva", "batman"] })),
}))
...
describe('CreateIssue', () => {
  it('should render the component', () => {
    ...
    const popUp = screen.getByText('Are you sure you want to cancel create issue?');
