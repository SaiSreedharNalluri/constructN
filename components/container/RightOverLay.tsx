...
import { faBug, faBullseye, faCirclePlus, faDatabase, faExclamationCircle, faEyeSlash, faList, faSitemap, faTasks } from '@fortawesome/free-solid-svg-icons';
    ...
    <div className="flex-col m-auto relative " ref={rightOverlayRefs}>
      <div ref={rightOverlayRef}>
        ...
        <div className=" cursor-pointer">
          ...
          {active === "b" ? <div className={`fixed w-24  ${rightNav ? "right-10" : "hidden"}`}>
        ...
        <div className=" cursor-pointer">
          ...
          {active === "c" ? <div className={`fixed w-24 right-16 ${rightNav ? "right-10" : "hidden"}`}>
            <Issue></Issue>
          </div> : ""}
        </div>
        <div className=" cursor-pointer">
          ...
          {active === "d" ? <div className={`fixed w-24  ${rightNav ? "right-10" : "hidden"}`}>
            <div className={`border border-solid bg-slate-500 p-1.5 rounded -mt-8 `}>
              <Tasks></Tasks>
            </div>
          </div> : ""}
        ...
        <div className=" cursor-pointer">
          <FontAwesomeIcon icon={faTasks} id='e' className={` w-full py-2  cursor-pointer ${active === "e" ? "selectedClass" : "unSelectedClass"} `} onClick={rightClickHandler}></FontAwesomeIcon>
          {active === "e" ? <div className={`fixed w-10 mb-10 bottom-1/4  ${rightNav ? "right-10" : "hidden"}`}>
