  ...
  if (data && data.length > 0) {
    return (
      <><div id="mapbox-hotspot" className='fixed right-0 overflow-auto	h-full w-auto bg-white pt-16'>
        <input className="m-2 placeholder:italic placeholder:text-slate-400 block bg-white w-auto border border-slate-300 rounded-md py-2 pl-9 pr-3 shadow-sm focus:outline-none focus:border-sky-500 focus:ring-sky-500 focus:ring-1 sm:text-sm" placeholder="Search..." type="text" name="search"/>
