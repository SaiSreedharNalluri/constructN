...
const TaskList: React.FC<IProps> = ({ visibility, closeOverlay }) => {

    const closeTaskView=()=>{
        closeOverlay();
    }
    return (
        <div className={`fixed ${visibility?'w-/14 h-screen':'w-0'} top-10     bg-gray-200 right-0 z-10 overflow-x-hidden`}>
