    ...
    <div className=" w-11 h-screen text-center bg-gray-200 border  border-gray-300">
      ...
      >
        <Image
          ...
          className={`  text-4xl m-auto py-2 cursor-pointer`}
        ></Image>
      </div>
      <div
        className={`${
      ...
      >
        <Image
          ...
          id="schedule"
          onClick={leftClickHandler}
          className={` text-4xl py-2 m-auto  cursor-pointer  `}
        ></Image>
      </div>
      <div
        className={`${
      ...
      >
        <Image
          ...
          id="settings"
          onClick={leftClickHandler}
          className={`w-2/3 text-4xl m-auto py-2 cursor-pointer `}
        ></Image>
      </div>
      <div
        className={`mt-2 border-t border-solid border-gray-400 ${
          active === "structure" ? "visible" : "hidden"
        } `}
      >
        <FontAwesomeIcon
          id="expand"
