...
export const VerifyUserDiv = styled("div")({
  display: "flex",
  flexDirection: "column",
  justifyContent: "center",
  alignItems: "center",
...
export const MessageDivShow = styled("div")({
  color: "#36415D",
  width: "200px",
  height: "30px",
  fontFamily: "Open Sans",
...
export const SentDivShow = styled("div")({
  color: "#36415D",
  width: "340px",
  height: "40px",
...
export const LinkExpireDiv = styled("div")({
  color: "#36415D",
  width: "340px",
  height: "20px",
  fontFamily: "Nunito Sans",
...
export const ChangeSignDiv = styled("div")({
  color: "#FD5B0E",
  width: "340px",
  height: "24px",
  fontFamily: "Open Sans",
...
export const ResendMailDiv  = styled("div")({
  color: "#36415D",
  width: "259px",
  height: "19px",
  fontFamily: "Open Sans",
