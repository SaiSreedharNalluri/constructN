 ...
 */
export async function createPdfFromHtml(element, data) {
  const pdfProps = await createPdfProps(element);
  createPdf(pdfProps, data);
}
 ...
 */
function createPdf(pdfProps, data) {
  ...
  const documentDefinitions = {
    ...
    //   ...contentSize,
    // },
    content: [{ text: "Dynamic parts", style: "header" }, data],
    pageMargins,
  };
